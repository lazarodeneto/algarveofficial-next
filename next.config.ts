...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    qualities: [50, 52, 54, 56, 64, 68, 72, 80],
    ...
    remotePatterns: [
      ...
      { protocol: "https", hostname: "cdn.algarveofficial.com" },
      { protocol: "https", hostname: "**.algarveofficial.com" },
      { protocol: "https", hostname: "niylxpvafywjonrphddp.supabase.co", pathname: "/storage/v1/object/public/**" },
