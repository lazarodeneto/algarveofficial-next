...
const linkTranslationKeys: Record<string, string> = {
  // Categories
  "Places to Stay": "categories.premiumAccommodation",
  "Things to Do": "categories.premiumExperiences",
  "What's On": "categories.premierEvents",
  "Accommodation": "categories.premiumAccommodation",
  "Premium Accommodation": "categories.premiumAccommodation",
  ...
  "Algarve Experience": "categories.premiumExperiences",
  "Premium Experiences": "categories.premiumExperiences",
  "Family Attractions": "categories.premiumExperiences",
