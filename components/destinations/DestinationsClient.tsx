...
function DestinationsClientInner({ initialRegions }: DestinationsClientProps) {
  ...
  return (
    <div className="min-h-screen bg-background" data-cms-page="destinations">
      ...
      <CmsBlock pageId="destinations" blockId="hero" as="section" className={STANDARD_PUBLIC_HERO_WRAPPER_CLASS}>
        <LiveStyleHero
      ...
      {highlightedCity && (
        <CmsBlock pageId="destinations" blockId="featured-city-hub" as="section" className="py-16 lg:py-24">
          <div className="app-container content-max">
            ...
            >
              <h2 className="text-title font-serif font-medium text-foreground">
                {cms.getText("featured-city-hub.title", t("sections.cities.featuredHub", "Featured City Hub"))}
              </h2>
              <p className="mt-2 text-body text-muted-foreground">
                {cms.getText("featured-city-hub.subtitle", t("sections.cities.featuredHubSubtitle", "Discover our highlighted city"))}
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <LocaleLink
                ...
                className="glass-box group relative overflow-hidden rounded-2xl aspect-[21/9] luxury-card cursor-pointer block"
              >
                <div className="absolute inset-0">
                  {highlightedCity.hero_image_url || highlightedCity.image_url ? (
                    <Image
                ...
                <div className="absolute inset-0 p-8 lg:p-12 flex flex-col justify-end">
                  <span className="text-xs font-medium text-primary tracking-wider uppercase mb-3">
                    {t("sections.cities.highlightedCity", "Highlighted City")}
                  </span>
                  <h3 className="text-3xl lg:text-5xl font-serif font-medium text-white mb-3">{highlightedCity.name}</h3>
