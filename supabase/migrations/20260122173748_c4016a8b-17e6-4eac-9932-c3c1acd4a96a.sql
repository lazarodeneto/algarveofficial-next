-- Seed the 10 luxury regions for Algarve
INSERT INTO public.regions (name, slug, short_description, description, display_order, is_active, is_featured)
VALUES
  ('Golden Triangle', 'golden-triangle', 'The pinnacle of Algarve luxury living', 'Home to Quinta do Lago, Vale do Lobo, and Almancil - the most exclusive addresses in Portugal. World-class golf, private beaches, and unmatched prestige.', 1, true, true),
  ('Vilamoura Prestige', 'vilamoura-prestige', 'Europe''s premier marina destination', 'Iconic marina, championship golf courses, and vibrant nightlife. The heart of Algarve''s luxury tourism and international lifestyle.', 2, true, true),
  ...
  ('Lagos Signature', 'lagos-signature', 'Historic charm meets modern luxury', 'Ancient maritime heritage, stunning rock formations at Ponta da Piedade, and a thriving cultural scene. Authentic Algarve at its finest.', 4, true, true),
  ...
  ('Portimão Prime', 'portimao-prime', 'Dynamic coastal metropolis', 'Pristine Praia da Rocha, world-class motorsport, and vibrant dining scene. The Algarve''s most energetic luxury destination.', 9, true, true),
