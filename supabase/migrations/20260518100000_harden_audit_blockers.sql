...
ALTER TABLE IF EXISTS public.placement_slots ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.placement_slots FORCE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.listing_subscriptions ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.listing_subscriptions FORCE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.stripe_events_processed ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.stripe_events_processed FORCE ROW LEVEL SECURITY;
...
ALTER TABLE IF EXISTS public.slot_transactions ENABLE ROW LEVEL SECURITY;
ALTER TABLE IF EXISTS public.slot_transactions FORCE ROW LEVEL SECURITY;
...
-- Keep legacy slot RPCs off the public executable surface.
ALTER FUNCTION IF EXISTS public.confirm_slot_with_validation(UUID, TEXT, TEXT, INTEGER, INTEGER, TEXT)
  SET search_path = public, pg_temp;
ALTER FUNCTION IF EXISTS public.cleanup_stale_slots()
  SET search_path = public, pg_temp;
ALTER FUNCTION IF EXISTS public.reserve_slot(UUID, TEXT, TEXT, INTEGER, UUID, INTEGER, TEXT)
  SET search_path = public, pg_temp;
