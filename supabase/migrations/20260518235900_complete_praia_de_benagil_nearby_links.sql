...
[
  {
    ...
    "distance": "~0.1 km",
    "description": "Published AlgarveOfficial beach-club listing beside Praia de Benagil; approximate distance calculated from stored listing coordinates.",
  ...
  },
  {
    ...
    "type": "Restaurant",
    "distance": "~2.5 km",
    "description": "Published AlgarveOfficial restaurant listing in Lagoa; approximate distance from Benagil calculated from stored listing coordinates.",
  ...
  },
  {
    ...
    "type": "Restaurant",
    "distance": "~4.4 km",
    "description": "Published AlgarveOfficial restaurant listing in Carvoeiro; approximate distance from Benagil calculated from stored listing coordinates.",
...
[
  {
    ...
    "type": "Experience",
    "distance": "~0.0 km",
    "description": "Published AlgarveOfficial experience listing at Benagil by stored coordinates; any cave activity should follow current Maritime Authority rules.",
  ...
  },
  {
    ...
    "type": "Experience",
    "distance": "~0.2 km",
    "description": "Published AlgarveOfficial experience listing near Praia de Benagil by stored coordinates; any cave activity should follow current Maritime Authority rules.",
  ...
  },
  {
    ...
    "distance": "~4.5 km",
    "description": "Published AlgarveOfficial family-attraction listing near Benagil by stored listing coordinates.",
...
begin
  ...
  if v_listing_id is null then
    raise notice 'Published listing praia-de-benagil-lagoa not found; skipping update.';
    return;
  end if;
  ...
  v_sources := (
    ...
    from (
      ...
      select jsonb_build_object(
        ...
        'source_url', 'https://algarveofficial.com/listing/praia-de-benagil-lagoa',
        ...
        'facts_verified', jsonb_build_array(
          ...
          'Approximate nearby distances calculated from internal listing coordinates for Benagil and the linked listings',
  ...
  v_notes := (
    ...
    from (
      ...
      where note_item <> to_jsonb('Nearby restaurants and attractions are not manually populated unless they are existing published internal listings; the page may also render nearby published business listings from stored AlgarveOfficial location data.'::text)
      union all
  ...
  v_faq := (
    ...
    from (
      ...
      where faq_item->>'question' not in (
        'Are there restaurants near Praia de Benagil?',
        'What attractions are near Praia de Benagil?'
      )
      union all
      select jsonb_build_object(
        'question', 'Are there restaurants near Praia de Benagil?',
      ...
      union all
      select jsonb_build_object(
        'question', 'What attractions or experiences are near Praia de Benagil?',
