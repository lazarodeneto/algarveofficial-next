...
[
  {
    ...
    "type": "Restaurant",
    "distance": "~1.8 km",
    "description": "Published AlgarveOfficial restaurant listing in Carvoeiro; approximate distance from Vale Centeanes calculated from stored listing coordinates.",
  ...
  },
  {
    ...
    "type": "Restaurant",
    "distance": "~2.1 km",
    "description": "Published AlgarveOfficial restaurant listing in Lagoa; approximate distance from Vale Centeanes calculated from stored listing coordinates.",
  ...
  },
  {
    ...
    "distance": "~2.6 km",
    "description": "Published AlgarveOfficial beach-club listing in Benagil; approximate distance from Vale Centeanes calculated from stored listing coordinates.",
  ...
  },
  {
    ...
    "type": "Restaurant",
    "distance": "~6.3 km",
    "description": "Published AlgarveOfficial restaurant listing in the Porches/Lagoa area; approximate distance from Vale Centeanes calculated from stored listing coordinates.",
...
[
  ...
  },
  {
    ...
    "distance": "~4.9 km",
    "description": "Published AlgarveOfficial family-attraction listing near Vale Centeanes by stored listing coordinates.",
...
begin
  ...
  if v_listing_id is null then
    raise notice 'Published listing praia-de-vale-centeanes-lagoa not found; skipping update.';
    return;
  end if;
  ...
  v_sources := (
    ...
    from (
      ...
      select jsonb_build_object(
        ...
        'source_url', 'https://algarveofficial.com/listing/praia-de-vale-centeanes-lagoa',
        ...
        'facts_verified', jsonb_build_array(
          ...
          'Approximate nearby distances calculated from internal listing coordinates for Vale Centeanes and the linked listings',
  ...
  v_faq := (
    ...
    from (
      ...
      where faq_item->>'question' not in (
        'Are there restaurants near Praia de Vale Centeanes?',
        'What attractions are near Praia de Vale Centeanes?',
        'What attractions or experiences are near Praia de Vale Centeanes?'
      )
      union all
      select jsonb_build_object(
        'question', 'Are there restaurants near Praia de Vale Centeanes?',
        'answer', 'Yes. AlgarveOfficial has internally published nearby restaurant and beach-club listings including Mar d''Fora - Restaurante Carvoeiro, Bon Bon, Benagil Beach Club, O Leão de Porches, Aladin Grill and Atlântico. Distances are approximate and calculated from stored listing coordinates.'
      )
      union all
      select jsonb_build_object(
        'question', 'What attractions or experiences are near Praia de Vale Centeanes?',
        'answer', 'Nearby internally published AlgarveOfficial listings include Blue Xperiences SUP Benagil Caves, Jump2adventure - Kayak&sup - Benagil, Gramacho Golf Course, Algarviews, Sand City and Slide & Splash. Any cave or sea activity should follow current Maritime Authority rules.'
      )
    ) as faqs
  );
