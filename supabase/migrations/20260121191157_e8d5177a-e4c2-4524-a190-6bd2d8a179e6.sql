...
('Premium Accommodation', 'premium-accommodation', 'Building2', 'Premium villas, hotels & resorts', 'Experience the finest premium accommodations across the Algarve region', 1, true, true),
...
('Wellness & Spas', 'wellness-spas', 'Sparkles', 'Premium spas & wellness retreats', 'Rejuvenate at world-class spas and wellness centers', 5, true, true),
...
('Concierge Services', 'vip-concierge', 'Concierge', 'VIP assistance & lifestyle management', 'Access exclusive concierge services for seamless premium experiences', 7, true, true),
('Premium Experiences', 'premium-experiences', 'Gem', 'Unique adventures & activities', 'Discover extraordinary experiences and bespoke adventures', 8, true, true),
...
('VIP Transportation', 'vip-transportation', 'Plane', 'Private jets, yachts & transfers', 'Travel in style with premium transportation services', 10, true, true),
('Prime Real Estate', 'real-estate', 'Home', 'Premium properties & investments', 'Explore premium real estate opportunities in the Algarve', 11, true, true),
...
('Shopping & Boutiques', 'shopping-boutiques', 'ShoppingBag', 'Premium shopping & designer boutiques', 'Discover exclusive boutiques and premium shopping destinations', 15, true, false)
