...
const STATIC_PATHS = [
  ...
  { path: "/beaches", priority: 0.87, changefreq: "daily" as const },
  { path: "/flights", priority: 0.84, changefreq: "weekly" as const },
  ...
  { path: "/relocation", priority: 0.6, changefreq: "weekly" as const },
