...
const iconOptions = [
  "Cookie", "Settings", "Database", "Shield", "Info", "FileText",
  "CheckCircle", "XCircle", "Clock", "Globe", "Lock", "Eye"
];

export default function AdminCookiePage() {
  const { settings, isLoading, updateSettings } = useCookieSettings();
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Edit the Cookie Policy page content
            </p>
          </div>
        </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="This Cookie Policy explains how we use cookies..."
                rows={4}
              />
            </div>
          </CardContent>
          ...
          <CardContent>
            {formData.sections.length === 0 ? (
              <p className="text-sm text-muted-foreground text-center py-8">
                No sections yet. Add sections to build your Cookie Policy page, or leave empty to use the default content.
              </p>
            ) : (
                      ...
                      <div className="grid gap-4 md:grid-cols-2">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            placeholder="1. What Are Cookies"
                          />
                        </div>
                        <div className="space-y-2">
                          <Label>Icon</Label>
