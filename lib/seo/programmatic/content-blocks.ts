  ...
  "pt-pt": {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "places-to-stay": `O alojamento em ${cityName} vai desde casas de hóspedes boutique com azulejos pintados à mão a resorts de cinco estrelas com piscina privada e vistas para o Atlântico. ${cityDesc}. O AlgarveOfficial lista apenas propriedades que cumprem os nossos critérios de excelência.`,
        ...
        "things-to-do": `Para além das praias, ${cityName} surpreende o visitante com uma oferta de experiências extraordinária. ${cityDesc}. Desde passeios de barco privado até workshops culturais imersivos.`,
        "beaches-clubs": `As praias perto de ${cityName} conquistaram o seu lugar entre as melhores da Europa. ${cityDesc}. A nossa seleção inclui enseadas desertas e beach clubs com serviço premium.`,
        ...
        "shopping-boutiques": `Fazer compras em ${cityName} é descobrir boutiques independentes, mercados de artesãos e concept stores que refletem o carácter autêntico do Algarve. ${cityDesc}.`,
        "algarve-services": `Tirar o máximo partido do Algarve requer o apoio certo — desde transfers de luxo a serviços de concierge privado. ${cityDesc}.`,
        "whats-on": `A agenda de eventos de ${cityName} reflete a energia do Algarve. ${cityDesc}. De noites de jazz à beira-mar a festivais de gastronomia e jantares privados exclusivos.`,
      };
  ...
  fr: {
    ...
    body: ({ categoryDisplayName, cityName, canonical }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "things-to-do": `Au-delà des plages, ${cityName} surprend par l'extraordinaire variété de ses expériences. Des croisières privées aux ateliers culturels, en passant par les sports nautiques.`,
        "beaches-clubs": `Les plages de ${cityName} figurent parmi les plus belles d'Europe — sable doré, eaux turquoise et une atmosphère détendue qui définit l'expérience Algarve.`,
        ...
        "shopping-boutiques": `Faire du shopping à ${cityName}, c'est découvrir des boutiques indépendantes, marchés artisanaux et concept stores qui reflètent l'authenticité de l'Algarve.`,
        "algarve-services": `Pour profiter pleinement de l'Algarve, il faut les bons partenaires — transferts privés, conciergerie de luxe, gestion de propriété et location de yachts.`,
        "whats-on": `L'agenda d'événements de ${cityName} reflète toute l'énergie de l'Algarve — soirées jazz en bord de mer, festivals gastronomiques et dîners privés exclusifs.`,
      };
  ...
  de: {
    ...
    body: ({ categoryDisplayName, cityName, canonical }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "things-to-do": `Jenseits der Strände überrascht ${cityName} mit einem außergewöhnlichen Erlebnisangebot — von privaten Bootstouren bis zu kulturellen Workshops.`,
        "beaches-clubs": `Die Strände bei ${cityName} gehören zu Europas schönsten — goldener Sand, türkisfarbenes Wasser und das entspannte Flair, das die Algarve ausmacht.`,
        ...
        "shopping-boutiques": `Shopping in ${cityName} bedeutet, unabhängige Boutiquen, Handwerksmärkte und Concept Stores zu entdecken, die den authentischen Charakter der Algarve widerspiegeln.`,
        "algarve-services": `Um das Beste aus der Algarve herauszuholen, brauchen Sie die richtigen Partner — Luxustransfers, privater Concierge-Service und Yachtcharter.`,
        "whats-on": `Der Veranstaltungskalender in ${cityName} spiegelt die volle Energie der Algarve wider — Jazzabende am Meer, Gastronomiefestivals und exklusive private Dinners.`,
      };
  ...
  es: {
    ...
    body: ({ categoryDisplayName, cityName, canonical }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "things-to-do": `Más allá de las playas, ${cityName} sorprende con una extraordinaria variedad de experiencias — desde excursiones en barco privado hasta talleres culturales inmersivos.`,
        "beaches-clubs": `Las playas de ${cityName} están entre las mejores de Europa — arena dorada, aguas turquesas y el ambiente relajado que define la experiencia del Algarve.`,
        ...
        "shopping-boutiques": `Hacer compras en ${cityName} es descubrir boutiques independientes, mercados de artesanos y concept stores que reflejan el carácter auténtico del Algarve.`,
        "algarve-services": `Para aprovechar al máximo el Algarve se necesitan los socios adecuados — transfers de lujo, servicio de conserjería privado y alquiler de yates.`,
        "whats-on": `La agenda de eventos de ${cityName} refleja toda la energía del Algarve — noches de jazz junto al mar, festivales gastronómicos y cenas privadas exclusivas.`,
      };
  ...
  it: {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "shopping-boutiques": `Fare shopping a ${cityName} significa scoprire boutique indipendenti, mercati artigianali e concept store che riflettono il carattere autentico dell'Algarve. ${cityDesc}. Da prodotti artigianali in sughero e ceramiche di design locale alla moda contemporanea e al cibo gourmet, le nostre selezioni vi guidano verso le migliori esperienze di acquisto.`,
        "algarve-services": `Sfruttare al massimo l'Algarve richiede il giusto supporto — da transfer di lusso e servizi di concierge privato alla gestione di proprietà e noleggio di yacht. ${cityDesc}. Le selezioni di servizi di AlgarveOfficial a ${cityName} sono verificate per professionalità, affidabilità e gli standard elevati che i nostri membri si aspettano.`,
        "whats-on": `Il calendario eventi di ${cityName} riflette tutta l'energia della vita dell'Algarve. ${cityDesc}. Da serate jazz sul mare e festival gastronomici a cene private esclusive e celebrazioni culturali, le nostre selezioni di eventi vi tengono aggiornati su ciò che accade ora.`,
      };
  ...
  nl: {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "places-to-stay": `Accommodaties in ${cityName} variëren van charmante boutique-hotels met handgeschilderde azulejos tot vijfsterrenresorts met privézwembad en uitzicht op de Atlantische Oceaan. ${cityDesc}. AlgarveOfficial vermeldt alleen accommodaties die voldoen aan onze premiumstandaarden — onafhankelijke inspecties, gasttevredenheid en authentiek lokaal karakter.`,
        ...
        "shopping-boutiques": `Winkelen in ${cityName} betekent het ontdekken van onafhankelijke boetiekjes, ambachtsmarkten en conceptstores die het authentieke karakter van de Algarve weerspiegelen. ${cityDesc}. Van handgemaakte kurkproducten en lokaal ontworpen keramiek tot hedendaagse mode en gastronomisch voedsel, onze selecties leiden u naar de beste winkelervaring.`,
        "algarve-services": `Het meeste halen uit de Algarve vereist de juiste ondersteuning — van luxe transfers en privé-conciërgdiensten tot vastgoedbeheer en jachtcharter. ${cityDesc}. De servicevermeldingen van AlgarveOfficial in ${cityName} zijn gecontroleerd op professionaliteit, betrouwbaarheid en de hoge standaarden die onze leden verwachten.`,
        "whats-on": `De evenementenagenda van ${cityName} weerspiegelt de volledige energie van het leven in de Algarve. ${cityDesc}. Van jazz-aan-zee-avonden en gastronomische festivals tot exclusieve privédineers en culturele vieringen, onze gecureerde evenementenselecties houden u verbonden met wat er nu gebeurt.`,
      };
  ...
  sv: {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "places-to-stay": `Boendealternativ i ${cityName} sträcker sig från boutique-gästhus med handmålade azulejos till femstjärniga resorter med privata pooler och utsikt över Atlanten. ${cityDesc}. AlgarveOfficial listar bara fastigheter som uppfyller våra premiumstandarder — oberoende inspektioner, fokus på gästupplevelse och genuint lokalt karaktär.`,
        ...
        "things-to-do": `Bortom stränderna överraskar ${cityName} den nyfikne resenären med ett extraordinärt utbud av upplevelser. ${cityDesc}. Från privata båtturer längs kusten till fördjupande kulturella workshops och adrenalinfyllda vattensporter kopplar AlgarveOfficial dig samman med Algarvens mest minnesvärda aktiviteter.`,
        "beaches-clubs": `Stränderna nära ${cityName} har förtjänat sin plats bland Europas finaste — guldsand, turkost vatten och en avslappnad atmosfär som definierar Algarve-upplevelsen. ${cityDesc}. Våra urval inkluderar både orörda vikar och fullt betjänade strandklubbar där premiumligsoffor och cocktails väntar.`,
        ...
        "shopping-boutiques": `Shopping i ${cityName} innebär att upptäcka oberoende butiker, hantverksmarknader och konceptbutiker som speglar Algarvens autentiska karaktär. ${cityDesc}. Från handgjorda korkprodukter och lokalt designad keramik till modern mode och gourmetmat guidar våra urval dig till de bästa butiksupplevelserna.`,
        "algarve-services": `Att få ut det mesta av Algarve kräver rätt stöd — från lyxiga transfertjänster och privat concierge till fastighetsförvaltning och yacht-charter. ${cityDesc}. AlgarveOfficial:s serviceurval i ${cityName} är verifierade för professionalism, tillförlitlighet och de höga standarder våra medlemmar förväntar sig.`,
        "whats-on": `${cityName}s evenemangskalender speglar all energi i Algarvens liv. ${cityDesc}. Från jazzkväll vid havet och gastronomiifestivaler till exklusiva privata middagar och kulturella firanden håller våra utvalda evenemang dig uppdaterad med vad som händer just nu.`,
      };
  ...
  no: {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "places-to-stay": `Overnattingsmuligheter i ${cityName} spenner fra sjarmerende boutique-gjestehus med håndmalte azulejos til femstjerners resorter med private bassenger og utsikt over Atlanterhavet. ${cityDesc}. AlgarveOfficial lister bare eiendommer som oppfyller våre premiumstandarder — uavhengige inspeksjoner, fokus på gjesteopplevelse og ekte lokal karakter.`,
        ...
        "things-to-do": `Bortenfor strendene overrasker ${cityName} den nysgjerrige reisende med et ekstraordinært spekter av opplevelser. ${cityDesc}. Fra private båtturer langs kysten til fordypende kulturelle workshops og adrenalinfylte vannsporter, kobler AlgarveOfficial deg med Algarvens mest minnerike aktiviteter.`,
        "beaches-clubs": `Strendene nær ${cityName} har fortjent sin plass blant Europas fineste — gylden sand, turkist vann og en avslappet atmosfære som definerer Algarve-opplevelsen. ${cityDesc}. Utvalget vårt inkluderer både urørte viker og fullt betjente strandklubber der premiumsolsenger og cocktailer venter.`,
  ...
  da: {
    ...
    body: ({ categoryDisplayName, cityName, canonical, cityDescription }) => {
      ...
      const blurbs: Record<CanonicalCategorySlug, string> = {
        ...
        "things-to-do": `Ud over strændene overrasker ${cityName} den nysgerrige rejsende med et ekstraordinært udvalg af oplevelser. ${cityDesc}. Fra private bådture langs kysten til fordybende kulturelle workshops og adrenalinfyldte vandsport forbinder AlgarveOfficial dig med Algarvens mest mindeværdige aktiviteter.`,
        "beaches-clubs": `Strændene nær ${cityName} har fortjent deres plads blandt Europas fineste — gyldent sand, turkisblåt vand og en afslappet atmosfære, der definerer Algarve-oplevelsen. ${cityDesc}. Vores udvalg inkluderer både uberørte vige og fuldt betjente strandklubber, hvor premium-solsenge og cocktails venter.`,
        ...
        "shopping-boutiques": `Shopping i ${cityName} betyder at opdage uafhængige butikker, håndværksmarkeder og konceptbutikker, der afspejler Algarvens autentiske karakter. ${cityDesc}. Fra håndlavede korkprodukter og lokalt designet keramik til moderne mode og gourmetmad guider vores udvalg dig til de bedste butiksoplevelser.`,
        "algarve-services": `At få mest muligt ud af Algarve kræver den rette støtte — fra luksuriøs transfer og privat concierge-service til ejendomsadministration og yachtcharter. ${cityDesc}. AlgarveOfficial:s servicevalg i ${cityName} er verificeret for professionalisme, pålidelighed og de høje standarder, som vores medlemmer forventer.`,
        "whats-on": `${cityName}s begivenhedskalender afspejler al energien i det algarvske liv. ${cityDesc}. Fra jazz-ved-havet-aftener og gastronomifestivaler til eksklusive private middage og kulturelle fejringer holder vores kuraterede begivenhedsvalg dig forbundet med, hvad der sker lige nu.`,
      };
