...
export const DEFAULT_SEO = {
  title: "Premium Algarve Guide | AlgarveOfficial",
  description:
...
export const STATIC_PAGE_SEO = {
  ...
  "/blog": {
    title: "Algarve Blog: Travel Guides, Lifestyle & Premium Insights",
    description:
  ...
  "/map": {
    ...
    description:
      "Explore an interactive Algarve map with premium properties, experiences, dining, and events using live filters and clustered category markers.",
    ogType: "website",
  },
  "/partner": {
    title: "Partner With AlgarveOfficial | Add or Claim Your Listing",
    description:
      "Add your Algarve business listing or claim an existing profile to reach qualified premium travelers, residents, and investors.",
    ogType: "website",
  },
  "/contact": {
    title: "Contact AlgarveOfficial | Concierge & Local Support",
    description:
      "Contact AlgarveOfficial for concierge support, partnership inquiries, and local expertise across premium travel, property, and services in the Algarve.",
    ogType: "website",
  },
  "/trips": {
  ...
  "/about-us": {
    title: "About AlgarveOfficial | Premium Algarve Platform",
    description:
